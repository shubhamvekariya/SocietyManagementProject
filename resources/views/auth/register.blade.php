                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <input id="society_name" name="society_name" type="text"
                                            class="form-control required" value={{ old('society_name') }}>
                                    </div>
                                    <div class="form-group">
                                        <label>Address</label>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input id="pnumber" name="phoneno" type="number" min="0"
                                            class="form-control required" value={{ old('phoneno') }}>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Age*</label>
                                        <input id="number" name="age" type="age" class="form-control required"
                                            value={{ old('age') }}>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name_or_number" name="name_or_number" type="text"
                                            class="form-control required" value={{ old('name_or_number') }}>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>BHK</label>
                                        <input id="BHK" name="BHK" type="number" class="form-control"
                                            value={{ old('BHK') }}>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="floor_no" name="floor_no" type="number" class="form-control"
                                            value={{ old('floor_no') }}>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="society_id" name="society_id" required>
                                            ...
                                            @foreach ($societies as $society)
                                                <option value="{{ $society->id }}">{{ $society->society_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
