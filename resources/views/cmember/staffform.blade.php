...
<div class="form-group">
    ...
    <input id="email" name="email" type="email" class="form-control" placeholder="Email"
        value='@if (isset($staff->email)) {{ $staff->email }} @endif'>
</div>
<div class="form-row">
    <div class="form-group col-md-6">
        <label for="name">Name</label>
        <input id="name" name="name" type="text" class="form-control" placeholder="Name"
            value='@if (isset($staff->name)) {{ $staff->name }} @endif'>
    </div>
    <div class="form-group col-md-6">
        <label>Gender</label>
...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        <input id="salary" name="salary" type="number" class="form-control" placeholder="Salary (per month)(in k)"
            value="@if (isset($staff->salary)) {{ $staff->salary }} @endif">
    </div>
    <div class="form-group col-md-6">
