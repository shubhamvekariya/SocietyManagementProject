					...
					<div class="card-deck mx-auto">
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Here, Visitor Can Pre Approve to Visit Member in society,Security allows for Visiting,Parking Details is also Managed.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Communication is done between Member and Committee member About Any Issue,So he/she can Chat.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Maintenance Bill is Generated on Basis of Expenses, and Bill is Sent to Member through Mail, and User Can Pay Online Bill.</p>
							</div>
						</div>
					</div>
					<div class="card-deck mx-auto">
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Management of Staff is Done, Add Staff, Remove Staff, Attendence of Staff Monthly wise is done.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Here, Member can Register Complaint, Add description and As soon as committe member Resolves complaint, Member is Notified That the Complaint is Resolved.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Member Can Book Assets/Events on Basis of Assets/Events Charges Are Decided.</p>
							</div>
						</div>
					</div>
				</div> <!-- gallery page 1 -->
					...
					<div class="card-deck mx-auto mx-auto">
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">A Committee member can Manage Members and Expenses on which bill is being generated.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
					...
					<div class="card-deck mx-auto">
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Committee Member Can Add Staff Remove Staff can Pay Salary Monthly wise to Staffs.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								<h5 class="card-title">Communication</h5>
								<p class="card-text">Committee Member Can Communicate with Members Reagarding any issues.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								<h5 class="card-title">Complaint management</h5>
								<p class="card-text">Committee Member Can Resolve the Complaint and Can Notify the member that Complaint resolved.</p>
							</div>
						</div>
					</div>
				</div> <!-- gallery page 2 -->
					...
					<div class="card-deck mx-auto mx-auto">
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Secretary Can have List of Rules, Can Add, Remove, Modify rules.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Secretary Can Add, Remove Committee Members, which is done only by Admin.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Secretary Can Manage Users like Security & Staff, Members, Committee members.</p>
							</div>
						</div>
					</div>
				</div> <!-- gallery page 3 -->
				...
				<div id="tm-gallery-page-securtiy-staff" class="tm-gallery-page hidden">
					<div class="card-deck mx-auto mx-auto">
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								<h5 class="card-title">Visitor management</h5>
								<p class="card-text">Security has rights to allow visitor or not,and Parking Details is also Managed.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Security Manages Parking Details of Visitors, who is not member of society.</p>
							</div>
						</div>
						<div class="card p-3 m-3" >
							...
							<div class="card-body">
								...
								<p class="card-text">Staff & security Salary is Managed Acording to work & Salary is Paid Monthly wise.</p>
							</div>
						</div>
					</div>
				</div> <!-- gallery page 4 -->
