    ...
    <div class="container-fuild">
                    ...
                    <div class="row tm-header-inner mx-0">
                        ...
                        <nav class="col-md-6 col-12 tm-nav">
                            <ul class="tm-nav-ul">
                                ...
                                <li class="tm-nav-li"><a href="{{ route('about_us') }}"
                                        class="tm-nav-link active">About</a></li>
        ...
        <main>
            <header class="row tm-welcome-section">
                ...
                <p class="col-12 text-center">Society management system in which society members can have facilities
                    like notice board, book events, track of their income & expenses, complaints status etc.
                    And make payment through cash or online payment gateway.<br><br>
                    Committee member will be interacting with society members for bills (maintenance bill, gas bill
                    etc.),
