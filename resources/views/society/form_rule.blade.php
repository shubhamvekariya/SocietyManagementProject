...
<div class="form-group row">
    ...
    <div class="col-lg-9"><textarea  rows="3" class="form-control" placeholder="Enter Rules" name="description">@if(isset($rules->description)){{ $rules['description']}}@endif</textarea></div>
</div>
